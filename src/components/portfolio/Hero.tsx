  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden noise-overlay">
      ...
      <div className="absolute inset-0 bg-background">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-muted/30 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-muted/20 rounded-full blur-3xl animate-pulse-slow delay-1000" />
      </div>
          ...
          >
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="glass-card p-4 glow-box hover:bg-muted/20 transition-all duration-300"
